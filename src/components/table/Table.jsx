    ...
    <div className="media h-auto">
      <div className="media-body w-full">
        <div className='d-flex flex-row justify-start align-items-center'>
          <Button color="primary" className="p-2 text-sm">Bids Open for Bidding</Button>
          <Button color="danger" className="p-2 d-flex flex-row align-items-center justify-content-center gap-2 text-sm">
